...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
                                ::BANGMAPLE PROJECT RESERVED::
                          :::: http://facebook.com/BangMaple/ ::::
::--------------------------------------------------------------------------------------------------------------------------------------------------------
:: WELCOME TO BANGMAPLE'S PROJECT. CODENAME: ADOBE PORTABLE PACK CC 2018 ::
:: BEEN WORKING ON THIS PROJECT SINCE MARCH 2018 AND BEEN UPDATING FREQUENTLY SO AS TO GIVE A BETTER ENVIRONMENT TO USERS ::
:: HTTP://FACEBOOK.COM/BANGMAPLEPROJECT/ ::
::--------------------------------------------------------------------------------------------------------------------------------------------------------
:: WHAT WILL THIS PROJECT BE DONE FOR USERS ?
:: IT WILL PROVIDE A PLENTY OF USEFUL PORTABLE PACKS FOR USERS HANDMADE BY BANGMAPLE ::
:: USED WINRAR, 7-ZIP,.. TO GIVE THE BEST EXPERIENCE AND PERFORMANCE FOR INSTALLING, EXTRACTING ::
::--------------------------------------------------------------------------------------------------------------------------------------------------------
:: MANY PEOPLE WANT TO EXPLORE MY SOFTWARE LIKE THIS, IF YOU ARE SEEING THIS LINE ::
:: JUST GIVE IT A SHOT TO READ THE BELOW THINGS ::
:: YOU ARE VERY GOOD AT EXPLORING OTHERS'S COMMANDS AND BATCH FILES TO MAKE YOURSELF ONE OR FOR STUDYING PURPOSES ::
:: I HATE PEOPLE WHO WANT TO READ INSIDE THEIR PROJECTS BUT JUST CALM DOWN ::
:: DON'T SPREAD THESE THINGS TO THE OTHER SITES, THINGS, I DON'T WANT MY HOURS OF WORK WASTED ::
:: SO DON'T DO ANYTHING MAKE ME SAD ::
:: MANY THANKS TO YOU ::
::--------------------------------------------------------------------------------------------------------------------------------------------------------
::--------------------------------------------------------------------------------------------------------------------------------------------------------
::--------------------------------------------------------------------------------------------------------------------------------------------------------
